...
-   MRS 3.1.0及之后版本，请参考[集群Master节点规格升级（一键升级）](#section931793154614)
-   MRS 1.8.2及之后版本至MRS 3.x之前版本，请参考[集群Master节点规格升级（一键升级）](#section931793154614)操作。
-   MRS 1.8.2之前版本和MRS 3.0.5版本，请参考[集群Master节点规格升级（分步升级）](#section43251723164812)操作。

## 集群Master节点规格升级（一键升级）<a name="section931793154614"></a>
...
## 集群Master节点规格升级（分步升级）<a name="section43251723164812"></a>
...
5.  登录Manager，进入集群管理页面，具体请参见[访问MRS Manager（MRS 2.x及之前版本）](访问MRS-Manager（MRS-2-x及之前版本）.md)。
...
1.  <a name="li1571022151014"></a>登录Manager，进入集群管理页面，具体请参见[访问MRS Manager（MRS 2.x及之前版本）](访问MRS-Manager（MRS-2-x及之前版本）.md)。
...
7.  登录Manager，进入集群管理页面，具体请参考[访问MRS Manager（MRS 2.x及之前版本）](访问MRS-Manager（MRS-2-x及之前版本）.md)。
