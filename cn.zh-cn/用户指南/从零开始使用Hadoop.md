...
3.  上传数据至OBS。
    ...
    4.  进入program文件夹，单击![](figures/icon_mrs_obsmanu.jpg)，从本地选择[1](从零开始使用Hadoop.md#zh-cn_topic_0023976402_li1162925161421)中下载的程序包，然后单击“上传“，上传完成后如[图2](#zh-cn_topic_0023976402_fig63158979162142)所示。
