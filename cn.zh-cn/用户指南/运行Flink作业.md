...
6.  “作业类型“选择“Flink“，参考[表 1](#tf38a01bf69f34c29a25317555fc32b92)配置Flink作业信息。
    ...
    **表 1**  作业配置信息
    ...
    <div class="note" id="note37771150161214"><a name="note37771150161214"></a><a name="note37771150161214"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p12108437424"><a name="p12108437424"></a><a name="p12108437424"></a>若使用<span class="parmvalue" id="parmvalue11701104312329"><a name="parmvalue11701104312329"></a><a name="parmvalue11701104312329"></a>“s3a://”</span>开头的OBS路径，请参考<a href="obs方式访问OBS.md#section269994210283">访问OBS</a>页面进行配置访问OBS的对应权限。</p>
