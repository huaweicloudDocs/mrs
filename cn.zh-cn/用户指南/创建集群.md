...
3.  参考下列表格配置集群基本信息。
    ...
    **表 1**  配置集群基本信息
    ...
    <p id="p558817711229"><a name="p558817711229"></a><a name="p558817711229"></a>选择集群工作区域下关联的可用区。集群工作区域在工具菜单处选择，目前工作区域支持“<span id="text1996932314264"><a name="text1996932314264"></a><a name="text1996932314264"></a>华南-广州</span>”、“<span id="text1259318752215"><a name="text1259318752215"></a><a name="text1259318752215"></a>华北-北京一</span>”、“<span id="text1259812772210"><a name="text1259812772210"></a><a name="text1259812772210"></a>华东-上海二</span>”和“华北-北京四”。各工作区域下关联的可用区如下：</p>
    ...
    <p id="p19756107142214"><a name="p19756107142214"></a><a name="p19756107142214"></a>通过单击<a name="image5230183645813"></a><a name="image5230183645813"></a><span><img id="image5230183645813" src="figures/icon_mrs_enable_hec-0.png"></span>或<a name="image32281913141217"></a><a name="image32281913141217"></a><span><img id="image32281913141217" src="figures/icon_mrs_disable_hec.png"></span>来关闭或开启Kerberos认证。</p>
    ...
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><div class="p" id="p2978676228"><a name="p2978676228"></a><a name="p2978676228"></a>提供三种集群类型：<a name="ul6981207172215"></a><a name="ul6981207172215"></a><ul id="ul6981207172215"><li>分析集群：用来做离线数据分析，提供的是Hadoop体系的组件。</li><li>流式集群：用来做流处理任务，提供的是流式处理组件。</li><li>混合集群：既可以用来做离线数据分析，也可以用来做流处理任务，提供的是Hadoop体系的组件和流式处理组件。建议同时需要做离线数据分析和流处理任务时使用混合集群。（MRS 1.8.2及之后版本支持混合集群。）</li></ul>
    </div>
