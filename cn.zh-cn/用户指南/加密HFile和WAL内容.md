...
9.  如果用户已按照[1](#zh-cn_topic_0263899618_li61064812194556)到[7](#zh-cn_topic_0263899618_li42092055194556)配置了SMS4或AES加密，但是在执行[8](#zh-cn_topic_0263899618_li50092082194556)创建表时，未设置对应的加密参数，使得插入的数据未经加密。
