# 添加租户<a name="ZH-CN_TOPIC_0173397652"></a>
...
1.  在集群详情页，单击“租户管理”。
    ...
    **图 2**  租户管理<a name="fig66227278302"></a>  
    ...
    >针对MRS 1.8.10及之前版本，具体请参见[添加租户](添加租户-148.md)。  
...
1.  在集群详情页，单击“租户管理”。
    ...
    **图 3**  租户管理<a name="fig1032721413319"></a>  
    ...
    >![](public_sys-resources/icon-note.gif) **说明：**   
    >针对MRS 1.8.10及之前版本，具体请参见[相关任务](添加租户-148.md#zh-cn_topic_0035271541_section28781070132624)。  
