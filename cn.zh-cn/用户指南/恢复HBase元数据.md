...
## 操作场景<a name="zh-cn_topic_0263899260_section60718452105032"></a>
...
## 对系统的影响<a name="zh-cn_topic_0263899260_section16795761105032"></a>

-   元数据恢复前，需要停止HBase服务，在这期间所有上层应用都会受到影响，无法正常工作。
-   元数据恢复后，会丢失从备份时刻到恢复时刻之间的数据。
-   元数据恢复后，需要重新启动HBase的上层应用。

## 前提条件<a name="zh-cn_topic_0263899260_section38869976105032"></a>
...
## 操作步骤<a name="zh-cn_topic_0263899260_section93383459252"></a>
