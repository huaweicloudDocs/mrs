...
<tbody><tr id="row60910108"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.1.4.1.1 "><p id="p47757325"><a name="p47757325"></a><a name="p47757325"></a>29104</p>
</td>
...
1.  在FusionInsight Manager首页，选择“运维 \> 告警 \> 告警”页面，找到“ALM-29104 Tserver进程内存占用率超过阈值”告警，查看告警来源。
2.  在“运维 \> 告警 \> 阈值设置 \> Kudu”，找到该告警的阈值，再对比集群Kudu实例的内存监控项，看是否超过阈值，处理内存使用率过高的问题，或修改阈值。
...
3.  单击右上角的![](figures/zh-cn_image_0295974380.png)设置日志收集的“开始时间”和“结束时间”分别为告警产生时间的前后10分钟，单击“下载”。
