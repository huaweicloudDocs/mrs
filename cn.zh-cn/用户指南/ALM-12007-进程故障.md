...
1.  检查实例进程是否异常。
    ...
    2.  在“告警管理”页面，查看是否有[ALM-12006 节点故障](ALM-12006-节点故障.md)产生。

        是，执行[1.c](#zh-cn_topic_0191813896_li2911734163437)。

        否，执行[1.d](#zh-cn_topic_0191813896_li13866005163437)。

    3.  <a name="zh-cn_topic_0191813896_li2911734163437"></a>按[ALM-12006 节点故障](ALM-12006-节点故障.md)提供的步骤处理该告警。
...
2.  检查磁盘空间是否不足。
    ...
    2.  <a name="zh-cn_topic_0191813896_li41496976164852"></a>按[ALM-12017 磁盘容量不足](ALM-12017-磁盘容量不足.md)提供的步骤处理该故障。
