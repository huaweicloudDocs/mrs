...
<tbody><tr id="row1516011104519"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p73304112515"><a name="p73304112515"></a><a name="p73304112515"></a>名称</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p93311311195117"><a name="p93311311195117"></a><a name="p93311311195117"></a>集群的名称，创建集群时设置。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p533171195118"><a name="p533171195118"></a><a name="p533171195118"></a>单击“点击查看”。</p>
...
<p id="p164391934132013"><a name="p164391934132013"></a><a name="p164391934132013"></a>目前支持MRS 1.8.10、MRS 2.0.5、MRS 2.1.0版本。</p>
</td>
</tr>
...
<tr id="row15697127143512"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p7160193112520"><a name="p7160193112520"></a><a name="p7160193112520"></a><span id="ph1374203415213"><a name="ph1374203415213"></a><a name="ph1374203415213"></a>IAM用户同步</span></p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p7160931185211"><a name="p7160931185211"></a><a name="p7160931185211"></a><span id="ph792874565215"><a name="ph792874565215"></a><a name="ph792874565215"></a>可以将IAM侧用户信息同步至MRS集群</span><span id="ph1197612115314"><a name="ph1197612115314"></a><a name="ph1197612115314"></a>，</span><span id="ph1819394015534"><a name="ph1819394015534"></a><a name="ph1819394015534"></a>用于集群管理。具体请参见<a href="IAM用户同步MRS.md">IAM用户同步MRS</a>。</span></p>
<div class="note" id="note109336324553"><a name="note109336324553"></a><a name="note109336324553"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p1193433265517"><a name="p1193433265517"></a><a name="p1193433265517"></a><span id="ph34622483190"><a name="ph34622483190"></a><a name="ph34622483190"></a>集群详情页的“组件管理”、“租户管理”和“备份恢复”页签需要同步用户后显示。</span></p>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p469193523211"><a name="p469193523211"></a><a name="p469193523211"></a>单击“点击查看”，查看集群关联的数据连接类型，具体请参考<a href="管理数据连接.md">管理数据连接</a>。</p>
</td>
</tr>
...
<tr id="row152792228350"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p1528082219351"><a name="p1528082219351"></a><a name="p1528082219351"></a>OBS权限控制</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p12802022153512"><a name="p12802022153512"></a><a name="p12802022153512"></a>单击“点击查看”，修改MRS用户与OBS权限的映射关系，具体请参考<a href="配置MRS多用户访问OBS细粒度权限.md">配置MRS多用户访问OBS细粒度权限</a>。</p>
</td>
</tr>
...
<tr id="row1147373165017"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p114731314500"><a name="p114731314500"></a><a name="p114731314500"></a><span id="ph885418135500"><a name="ph885418135500"></a><a name="ph885418135500"></a>安全组</span></p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p84735315016"><a name="p84735315016"></a><a name="p84735315016"></a><span id="ph19712125875119"><a name="ph19712125875119"></a><a name="ph19712125875119"></a>集群的安全组名称。</span></p>
</td>
</tr>
...
<tr id="row126871645143119"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p1768811455311"><a name="p1768811455311"></a><a name="p1768811455311"></a>节点名称</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p192609013336"><a name="p192609013336"></a><a name="p192609013336"></a>集群节点名称。</p>
<p id="p8260707332"><a name="p8260707332"></a><a name="p8260707332"></a>在<span class="wintitle" id="wintitle826016023313"><a name="wintitle826016023313"></a><a name="wintitle826016023313"></a>“节点管理”</span>页签，单击节点组名称前方的<a name="image048524816339"></a><a name="image048524816339"></a><span><img id="image048524816339" src="figures/zh-cn_image_0174691158.png"></span>，显示该节点组包含的节点，单击节点名称，使用创建集群时配置的密码或者密钥对远程登录弹性云服务器。</p>
</td>
</tr>
<tr id="row1270175811355"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p20318142812363"><a name="p20318142812363"></a><a name="p20318142812363"></a>IP</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p031814289368"><a name="p031814289368"></a><a name="p031814289368"></a>集群节点IP地址。</p>
</td>
</tr>
<tr id="row15980103362"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p101959171369"><a name="p101959171369"></a><a name="p101959171369"></a>状态</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p1196111703615"><a name="p1196111703615"></a><a name="p1196111703615"></a>节点状态信息。</p>
</td>
</tr>
<tr id="row552419920254"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p0524595251"><a name="p0524595251"></a><a name="p0524595251"></a>规格名</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p3524899255"><a name="p3524899255"></a><a name="p3524899255"></a>节点所使用的弹性云服务器规格名称。</p>
</td>
</tr>
<tr id="row423212016252"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p12232320142517"><a name="p12232320142517"></a><a name="p12232320142517"></a>规格</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p72261201297"><a name="p72261201297"></a><a name="p72261201297"></a>节点的实例规格，实例规格的配型由CPU+内存+Disk space共同决定。</p>
<div class="note" id="note162271092913"><a name="note162271092913"></a><a name="note162271092913"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p72277082912"><a name="p72277082912"></a><a name="p72277082912"></a>节点的实例规格配置越高，数据处理分析能力越强，集群所需费用也越多。</p>
</div></div>
</td>
</tr>
<tr id="row12787182811250"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p14787328202516"><a name="p14787328202516"></a><a name="p14787328202516"></a>节点类型</p>
</td>
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p148019418301"><a name="p148019418301"></a><a name="p148019418301"></a>节点类型：</p>
<a name="ul980114415305"></a><a name="ul980114415305"></a><ul id="ul980114415305"><li>Master：集群主节点，负责管理集群，协调将MapReduce可执行文件分配到核心节点。此外，还会跟踪每个作业的执行状态，监控DataNode的运行状况。</li><li>Core：集群核心节点，处理数据并在HDFS中存储过程数据。分析集群显示Analysis Core，流式集群显示Streaming Core，混合集群分别显示Analysis Core和Streaming Core。</li><li>Task：指集群Task节点，主要用于计算，不存放持久数据。Task节点为可选节点，数目可以是零。分析集群将显示Analysis Task，流式集群显示Streaming Task，混合集群分别显示Analysis Task和Streaming Task。</li></ul>
</td>
</tr>
