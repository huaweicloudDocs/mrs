...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p6331111112514"><a name="p6331111112514"></a><a name="p6331111112514"></a>集群状态信息，请参见<a href="概览.md#table164091551415">表1</a>。</p>
</td>
</tr>
...
<a name="ul17331191155116"></a><a name="ul17331191155116"></a><ul id="ul17331191155116"><li>针对MRS 3.x及以后版本，具体请参见<a href="访问FusionInsight-Manager（MRS-3-x及之后版本）.md">访问FusionInsight Manager（MRS 3.x及之后版本）</a></li><li>针对MRS 3.x之前版本，需要根据提示绑定弹性公网IP及添加安全组规则后才能进入MRS Manager页面，具体请参见<a href="访问Manager-2.md">访问Manager</a>。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p7115202972220"><a name="p7115202972220"></a><a name="p7115202972220"></a>可以将IAM侧用户信息同步至MRS集群，用于集群管理。具体请参见<a href="IAM用户同步MRS.md">IAM用户同步MRS</a>。</p>
