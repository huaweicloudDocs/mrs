# ALM-45176 OBS元数据接口调用成功率低于阈值<a name="ALM-45176"></a>
...
<tbody><tr id="row40652256"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.1.4.1.1 "><p id="p179511920165120"><a name="p179511920165120"></a><a name="p179511920165120"></a>45176</p>
</td>
...
<tr id="row65417491471"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.1 "><p id="p57854422"><a name="p57854422"></a><a name="p57854422"></a>Trigger condition</p>
</td>
...
1.  在FusionInsight Manager首页，选择“运维 \> 告警 \> 告警 \> OBS元数据接口调用成功率低于阈值”，查看“定位信息”中的角色名并确定实例的IP地址。
2.  选择“集群 \>  _待操作集群的名称_  \> 服务 \> meta \> 实例 \> meta（对应上报告警实例IP地址）”。单击图表区域右上角的下拉菜单，选择“定制”，在“OBS元数据操作”中勾选“OBS接口调用成功率”，单击“确定”，查看OBS元数据接口调用成功率，确定是否有接口调用成功率低于阈值。

    -   是，执行[3](#li5868113155910)。
    -   否，执行[5](#li4749473185459)。

    **图 1**  OBS接口调用成功率<a name="fig670713297526"></a>  
    ![](figures/OBS接口调用成功率.png "OBS接口调用成功率")

3.  <a name="li5868113155910"></a>选择“集群 \>  _待操作集群的名称_  \> 运维 \> 告警 \> 阈值设置  \> meta \> OBS元数据接口调用成功率”，将阈值或平滑次数参数的值根据实际情况调小。
4.  观察界面告警是否清除。
    -   是，处理完毕。
    -   否，执行[5](#li4749473185459)。
...
3.  单击右上角的![](figures/zh-cn_image_0276137858.png)设置日志收集的“开始时间”和“结束时间”分别为告警产生时间的前后30分钟，单击“下载”。
