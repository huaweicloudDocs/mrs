...
<tbody><tr id="row21396528"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.1.4.1.1 "><p id="p55397225"><a name="p55397225"></a><a name="p55397225"></a>12083</p>
</td>
...
<tbody><tr id="row87511840183416"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.1 "><p id="p17935380415"><a name="p17935380415"></a><a name="p17935380415"></a>来源</p>
</td>
...
**ommdba**密码过期，OMS数据库无法管理，数据不能访问。

## 可能原因<a name="section173917012523"></a>

该主机**ommdba**密码即将过期。

## 处理步骤<a name="section2544196205219"></a>

**检查系统中ommdba密码是否即将过期。**

1.  以**root**用户登录集群故障节点，用户密码为安装前用户自定义，请咨询系统管理员。

    执行**chage -l ommdba**命令来查看当前**ommdba**用户密码设置信息。
...
2.  查找“Password expires”对应值，查看密码设置是否即将过期。
    ...
    -   是，执行[3](#li95442685214)。
    -   否，执行[4](#li85441665528)。


1.  <a name="li95442685214"></a>执行**chage -M**_ '__天数' _**ommdba**命令设置**ommdba**密码的有效天数，等待8小时，观察告警是否自动清除。
    -   是，操作结束。
    -   否，执行[4](#li85441665528)。
...
1.  <a name="li85441665528"></a>在FusionInsight Manager界面，选择“运维 \> 日志 \> 下载”。
