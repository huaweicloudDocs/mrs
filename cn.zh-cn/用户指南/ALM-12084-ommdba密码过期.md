# ALM-12084 ommdba密码过期<a name="ALM-12084"></a>
...
<tbody><tr id="row21396528"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.1.4.1.1 "><p id="p55397225"><a name="p55397225"></a><a name="p55397225"></a>12084</p>
</td>
...
<tbody><tr id="row184681135103410"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.1 "><p id="p17935380415"><a name="p17935380415"></a><a name="p17935380415"></a>来源</p>
</td>
...
**ommdba**密码过期，Manager各节点互信不可用，无法对服务提供管理功能。

## 可能原因<a name="section1930732555420"></a>

该主机**ommdba**密码过期。

## 处理步骤<a name="section5152113865417"></a>
...
2.  查找“Password expires”对应值，查看密码设置是否过期。
    ...
    -   是，执行[3](#li1514993845412)。
    -   否，执行[4](#li01501938155415)。


1.  <a name="li1514993845412"></a>执行**chage -M**_ '__天数' _**ommdba**命令设置**ommdba**密码的有效天数，等待8小时，观察告警是否自动清除。
    -   是，操作结束。
    -   否，执行[4](#li01501938155415)。
...
1.  <a name="li01501938155415"></a>在FusionInsight Manager界面，选择“运维 \> 日志 \> 下载”。
