...
## 操作场景<a name="s94c084b9af5f4af4bc43be409b101b1a"></a>
...
## 对系统的影响<a name="s618fe949ea1640cdb33e6226d3911c36"></a>

-   恢复过程中会停止用户认证，用户无法开始新的连接。
-   数据恢复后，会丢失从备份时刻到恢复时刻之间的数据。
-   数据恢复后，需要重新启动Hive的上层应用。

## 前提条件<a name="s76ce034334fb42f485c3c9c645d9aad9"></a>
...
## 操作步骤<a name="s98accdce8adc47faa5d325206f80ef24"></a>
