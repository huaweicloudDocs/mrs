...
2.  在“维护“下单击“审计日志导出“。
    ...
    **表 1**  审计日志导出参数
    ...
    <td class="cellrowborder" valign="top" width="30%" headers="mcps1.2.4.1.2 "><a name="ul13788623171458"></a><a name="ul13788623171458"></a><ul id="ul13788623171458"><li><a name="image172797287269"></a><a name="image172797287269"></a><span><img id="image172797287269" src="figures/icon_mrs_enable_hec-0.png"></span>&nbsp;</li><li><a name="image338845142712"></a><a name="image338845142712"></a><span><img id="image338845142712" src="figures/icon_mrs_disable_hec.png"></span>&nbsp;</li></ul>
    </td>
    ...
    <a name="ul65127808163921"></a><a name="ul65127808163921"></a><ul id="ul65127808163921"><li><a name="image396911491289"></a><a name="image396911491289"></a><span><img id="image396911491289" src="figures/icon_mrs_enable_hec-0.png"></span>：启用审计日志导出。</li></ul>
    <a name="ul39695732171458"></a><a name="ul39695732171458"></a><ul id="ul39695732171458"><li><a name="image128151252299"></a><a name="image128151252299"></a><span><img id="image128151252299" src="figures/icon_mrs_disable_hec.png"></span>：禁用审计日志导出。</li></ul>
    </td>
    </tr>
