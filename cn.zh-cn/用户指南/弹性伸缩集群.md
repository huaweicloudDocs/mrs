...
在大数据应用，尤其是实时分析处理数据的场景中，常常需要根据数据量的变化动态调整集群节点数量以增减资源。MRS的弹性伸缩规则功能支持根据集群负载对集群进行弹性伸缩。此外，如果数据量以天为周期有规律的变化，并且希望在数据量变化前提前完成集群的扩缩容，可以使用MRS的资源计划特性。
...
3.  单击  ![](figures/zh-cn_image_0137846746.png) 展开集群详细信息，并单击“Task节点弹性伸缩“后的![](figures/zh-cn_image_0137846749.png)，进入“弹性伸缩“页面。
4.  配置弹性伸缩规则。
    ...
    **图 1**  弹性伸缩<a name="fig12471045164412"></a>  
    ...
    -   弹性伸缩：指定是否打开弹性伸缩，默认为关闭，开启后可配置下列参数。
    -   默认节点数量范围：输入Task实例弹性伸缩的数量范围，此约束应用于所有缩容扩容规则。取值范围为0～500。
...
1.  登录MRS管理控制台。
2.  选择“集群列表 \> 现有集群”，选中一运行中的集群并单击集群名。进入集群信息页面。
3.  单击  ![](figures/zh-cn_image_0140881844.png) 展开集群详细信息，并单击“Task节点弹性伸缩“后的![](figures/zh-cn_image_0140881846.png)，进入“弹性伸缩“页面。
4.  配置资源计划。
    ...
    2.  设置“默认节点数量范围“，此处设置为“2-2“，表示除资源计划规定时间范围外，其他时间Task节点数量固定为2个。
    3.  在弹性伸缩页面的“高级配置“项中单击“现在配置“。

        **图 4**  高级配置<a name="fig1219112112519"></a>  
        ![](figures/高级配置.png "高级配置")

    4.  配置“时间范围“和“节点数量范围“。此处“时间范围“设置为“07:00-13:00“，“节点数量范围“设置为“5-5“，表示在该时间范围内，Task节点数量固定为5个。
...
5.  （可选）配置自动化脚本。
    ...
    **图 5**  自动化脚本<a name="fig42437112519"></a>  
...
1.  登录MRS管理控制台。
2.  选择“集群列表 \> 现有集群”，选中一运行中的集群并单击集群名。进入集群信息页面。
3.  单击  ![](figures/zh-cn_image_0140881494.png) 展开集群详细信息，并单击“Task节点弹性伸缩“后的![](figures/zh-cn_image_0140881496.png)，进入“弹性伸缩“页面。
4.  配置弹性伸缩规则。

    弹性伸缩规则可调控节点数量，也会对实际价格有影响，请谨慎操作。

    **图 6**  弹性伸缩<a name="fig14150928164913"></a>  
    ![](figures/弹性伸缩.png "弹性伸缩")

    -   弹性伸缩：指定是否打开弹性伸缩，默认为关闭，开启后可配置下列参数。
    -   默认节点数量范围：输入Task实例弹性伸缩的数量范围，此约束应用于所有缩容扩容规则。此处配置为2-4个。
    -   伸缩规则：需要配置扩容或者缩容，否则弹性伸缩将不会启用。
        ...
        2.  单击“添加规则“，进入“添加规则“页面。
            ...
            **图 7**  添加规则<a name="fig719710286491"></a>  
            ![](figures/添加规则.png "添加规则")
...
5.  配置资源计划。
    ...
    1.  在弹性伸缩页面的“高级配置“项中单击“现在配置“。

        **图 8**  高级配置<a name="fig1424972814920"></a>  
        ![](figures/高级配置.png "高级配置")

    2.  配置“时间范围“和“节点数量范围“。此处“时间范围“设置为“07:00-13:00“，“节点数量范围“设置为“5-8“。
...
6.  配置自动化脚本
    ...
    **图 9**  自动化脚本<a name="fig3301128144911"></a>  
    ![](figures/自动化脚本.png "自动化脚本")
...
<p id="p111590455445"><a name="p111590455445"></a><a name="p111590455445"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p11170184515443"><a name="p11170184515443"></a><a name="p11170184515443"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p1718684518444"><a name="p1718684518444"></a><a name="p1718684518444"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p719594544416"><a name="p719594544416"></a><a name="p719594544416"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p62024454442"><a name="p62024454442"></a><a name="p62024454442"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p20209184515442"><a name="p20209184515442"></a><a name="p20209184515442"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p6214645114411"><a name="p6214645114411"></a><a name="p6214645114411"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p421984534416"><a name="p421984534416"></a><a name="p421984534416"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p1922854518444"><a name="p1922854518444"></a><a name="p1922854518444"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p112342452442"><a name="p112342452442"></a><a name="p112342452442"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p8250154534412"><a name="p8250154534412"></a><a name="p8250154534412"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p162551645164411"><a name="p162551645164411"></a><a name="p162551645164411"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p526116451444"><a name="p526116451444"></a><a name="p526116451444"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
...
<p id="p2276104511441"><a name="p2276104511441"></a><a name="p2276104511441"></a>取值范围为[0～2147483647]。</p>
</td>
</tr>
</tbody>
</table>
...
<tbody><tr id="row16466185474616"><td class="cellrowborder" valign="top" width="22.720000000000002%" headers="mcps1.2.3.1.1 "><p id="p184661549465"><a name="p184661549465"></a><a name="p184661549465"></a>起始时间</p>
</td>
<td class="cellrowborder" valign="top" width="77.28%" headers="mcps1.2.3.1.2 "><p id="p174661154154616"><a name="p174661154154616"></a><a name="p174661154154616"></a>资源计划的开始时间，精确到分钟，取值范围[00:00, 23:59]。例如资源计划开始于早上8:00，则配置为08:00。</p>
</td>
</tr>
<tr id="row84668549466"><td class="cellrowborder" valign="top" width="22.720000000000002%" headers="mcps1.2.3.1.1 "><p id="p17466145474620"><a name="p17466145474620"></a><a name="p17466145474620"></a>结束时间</p>
</td>
<td class="cellrowborder" valign="top" width="77.28%" headers="mcps1.2.3.1.2 "><p id="p164661454184612"><a name="p164661454184612"></a><a name="p164661454184612"></a>资源计划的结束时间，精确到分钟，取值范围[00:00, 23:59]。结束时间必须晚于开始时间至少30分钟。例如资源计划于10:00结束，则配置为10:00。</p>
</td>
</tr>
<tr id="row2390162211528"><td class="cellrowborder" valign="top" width="22.720000000000002%" headers="mcps1.2.3.1.1 "><p id="p1539132255216"><a name="p1539132255216"></a><a name="p1539132255216"></a>最小节点数</p>
</td>
<td class="cellrowborder" valign="top" width="77.28%" headers="mcps1.2.3.1.2 "><p id="p5391172265211"><a name="p5391172265211"></a><a name="p5391172265211"></a>资源计划内的节点数量下限，取值范围[0,500]，在资源计划时间内，集群Task节点数量小于最小节点数时，弹性伸缩会将集群Task节点一次性扩容到最小节点数。</p>
</td>
</tr>
<tr id="row17699422544"><td class="cellrowborder" valign="top" width="22.720000000000002%" headers="mcps1.2.3.1.1 "><p id="p14692042135419"><a name="p14692042135419"></a><a name="p14692042135419"></a>最大节点数</p>
</td>
<td class="cellrowborder" valign="top" width="77.28%" headers="mcps1.2.3.1.2 "><p id="p96904215543"><a name="p96904215543"></a><a name="p96904215543"></a>资源计划内的节点数量上限，取值范围[0,500]，在资源计划时间内，集群Task节点数量大于最大节点数时，弹性伸缩会将集群Task节点一次性缩容到最大节点数。</p>
</td>
</tr>
</tbody>
</table>
...
>-   当不启用资源计划时，“默认节点数量范围”不会强制生效，即使节点数量超出了“默认节点数量范围”，在伸缩规则未触发时，不会主动增减Task节点数量。  
...
<div class="note" id="note1385223393710"><a name="note1385223393710"></a><a name="note1385223393710"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul26783219257"></a><a name="ul26783219257"></a><ul id="ul26783219257"><li>如果选择Master节点，您可以通过<a name="image16678182112518"></a><a name="image16678182112518"></a><span><img id="image16678182112518" src="figures/zh-cn_image_0137846759.png"></span>选择是否只在Active Master节点执行此脚本。</li><li>如果选择开启此功能，表示只在Active Master节点上执行。如果选择关闭，表示在所有Master节点执行。默认关闭。</li></ul>
</div></div>
</td>
</tr>
...
<p id="p13861359884"><a name="p13861359884"></a><a name="p13861359884"></a></p>
</td>
</tr>
